...
{
    public partial class anhlinh : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3f8c0eff-a06a-4b07-a449-8832c622290d"), "1", "a", true, "1", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9310), "1", "a" },
                    { new Guid("f572907f-4e58-4ee3-b282-8100a3a2043f"), "2", "b", true, "1", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9313), "2", "b" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("bab26baa-d480-4030-dc34-08db31930274"), "1", "Ha Noi", "Ton12@gmail.com", true, new Guid("ae47eb40-97bc-4b24-0420-08db2a1480e8"), new Guid("bab26baa-d480-4030-dc34-08db31930274"), null, "NV", "123456", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9354), "0967052758", "Nguyễn Bá Tồn", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("51a13afd-08d1-4a20-a0e0-fb4447bd215d"), "null", "null", "null", "null", 200000m, 180000m, new Guid("5e5f7d51-044f-4928-9aac-4a496c629231"), new Guid("9a1b3786-d0d0-402a-bfd8-10db04f8e6ed"), "SP2", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9008), "V2", 1 },
                    { new Guid("7aaf5675-683d-4608-9534-ea737a4247b3"), "null", "null", "null", "null", 100000m, 80000m, new Guid("7a6c0c50-fb67-44ea-9c62-ad0e0f67ab3c"), new Guid("01bf8a6c-d89a-4db2-9068-af277be488ae"), "SP1", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(8994), "V1", 1 },
                    { new Guid("bcb53bdb-2f7e-4026-a5a3-09ff834562ad"), "null", "null", "null", "null", 200000m, 180000m, new Guid("cfa013b0-34dc-44d5-a471-7c49a9ac167d"), new Guid("9a1b3786-d0d0-402a-bfd8-10db04f8e6ed"), "SP2", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9016), "V2", 1 },
                    { new Guid("ec94662b-535d-4599-b462-9951c727be51"), "null", "null", "null", "null", 100000m, 80000m, new Guid("8d364a55-877f-45a5-9408-66afb8ab873f"), new Guid("01bf8a6c-d89a-4db2-9068-af277be488ae"), "SP1", new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9012), "V1", 1 }
                });
