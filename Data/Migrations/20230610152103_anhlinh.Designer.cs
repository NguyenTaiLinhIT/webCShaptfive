...
namespace _2_Data.Migrations
{
    ...
    [Migration("20230610152103_anhlinh")]
    partial class anhlinh
    {
            ...
            modelBuilder.Entity("Data.ModelsClass.KhachHang", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GioiTinh = true,
                            MatKhau = "1",
                            NgaySinh = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9310),
                            Sdt = "1",
                            Ten = "a"
                        },
                        new
                        {
                            ...
                            GioiTinh = true,
                            MatKhau = "1",
                            NgaySinh = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9313),
                            Sdt = "2",
                            Ten = "b"
                        });
                });
            ...
            modelBuilder.Entity("Data.ModelsClass.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MaNV = "NV",
                            MatKhau = "123456",
                            NgaySinh = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9354),
                            Sdt = "0967052758",
                            Ten = "Nguyễn Bá Tồn",
                            TrangThai = 1
                        });
            ...
            modelBuilder.Entity("Data.ModelsClass.SanphamChitiet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MaSPChiTiet = "SP1",
                            NgayTao = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(8994),
                            TenSPChiTiet = "V1",
                            TrangThai = 1
                        },
                        new
                        {
                            ...
                            MaSPChiTiet = "SP2",
                            NgayTao = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9008),
                            TenSPChiTiet = "V2",
                            TrangThai = 1
                        },
                        new
                        {
                            ...
                            IdSP = new Guid("01bf8a6c-d89a-4db2-9068-af277be488ae"),
                            MaSPChiTiet = "SP1",
                            NgayTao = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9012),
                            TenSPChiTiet = "V1",
                            TrangThai = 1
                        },
                        new
                        {
                            ...
                            IdSP = new Guid("9a1b3786-d0d0-402a-bfd8-10db04f8e6ed"),
                            MaSPChiTiet = "SP2",
                            NgayTao = new DateTime(2023, 6, 10, 22, 21, 3, 316, DateTimeKind.Local).AddTicks(9016),
                            TenSPChiTiet = "V2",
                            TrangThai = 1
                        });
                });
